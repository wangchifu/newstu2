...
@section('page_title')
<h1 class="text-danger">{{ $school->name }}「測試」編排班序</h1>
@endsection
...
<section class="section">
  <div class="row">
    <div class="container justify-content-center">
      <div class="card">
        <div class="card-body">
            <form method="post" action="{{ route('test_go_form_order',$school->id) }}" id="go_form">
            @csrf
                  ...
                  <td>
                    <table class="table table-bordered table-hover w-50">
                      ...
                      @for($i=0;$i<$school->class_num;$i++)
                        <?php 
                          $check_student = \App\Models\TestStudent::where('code',$school->code)->where('class',$eng_class[$i])->first();
                        ?>
                        <tr>
                          <td>
