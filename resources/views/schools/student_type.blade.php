              ...
              <table class="table table-bordered">
                <tr>
                  ...
                  <td>
                    ...
                    @foreach($spacial_student2 as $k=>$v)
                      <?php $wt=(!empty($student_data2[$semester_year][$k]['with_teacher']))?$student_data2[$semester_year][$k]['with_teacher']:"<span class='text-danger'>未設定</span>" ?>
                      <span class="badge bg-success position-relative" style="font-size: 15px;">{{ $student_data2[$semester_year][$k]['no']." ".$v }}
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                          -{{ $student_data2[$semester_year][$k]['subtract'] }}
                        </span>                
                      </span><span class="badge bg-info">+{!! $wt !!}</span>
                    @endforeach
                  </td>
                ...
                <tr>
                  <td>
                    雙胞胎同班：{{ $type2[2] }}：
                    @foreach($bao2_same as $k=>$v)
                    <span class="badge bg-warning" style="font-size: 15px;"><i class="bi bi-check-circle-fill"></i> {{ $student_data2[$semester_year][$k]['no']." ".$v }}</span><span class="badge bg-info">+{{ $student_data[$semester_year][$k]['another_no'] }}</span> 
                    @endforeach
                  </td>
                  <td>
                    雙胞胎不同班：{{ $type2[3] }}：
                    @foreach($bao2_not_same2 as $k=>$v)
                    <span class="badge bg-secondary" style="font-size: 15px;"><i class="bi bi-x-circle-fill"></i> {{ $student_data2[$semester_year][$k]['no']." ".$v }}</span><span class="badge bg-info">+{{ $student_data2[$semester_year][$k]['another_no'] }}</span>
                    @endforeach
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <span class="badge bg-info" style="font-size: 15px;"><i class="bi bi-check-circle-fill"></i> {{ $student_data2[$semester_year][$k]['no']." ".$v }}</span>
                    @endforeach
                  </td>
                  <td>
                    三胞胎全不同班：{{ $type2[5] }}：
                    @foreach($bao3_not_same2 as $k=>$v)
                    <span class="badge bg-dark" style="font-size: 15px;"><i class="bi bi-x-circle-fill"></i> {{ $student_data2[$semester_year][$k]['no']." ".$v }}</span>
                    @endforeach
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <span class="badge bg-primary position-relative" style="font-size: 15px;">
                      {{ $student_data2[$semester_year][$k]['no']." ".$v['student'] }}
                      <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        -{{ $v['teacher'] }}
                      </span>
                    </span>
