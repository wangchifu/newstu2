...
@section('page_title')
<h1 class="text-danger">{{ $semester_year }}學年{{ $school->name }}「測試」編班結果</h1>
@endsection
      ...
      <div class="card-body">
        <table class="table table-striped">
          <thead>
            <tr>
              <th colspan="5">
                <a href="{{ route('test_start') }}" class="btn btn-secondary"><i class="bi bi-chevron-double-left"></i> 返回</a> 全部分班一覽 <span class="small text-danger">◎請檢查是否流水號重複，如有缺號乃屬正常</span>
              </th>
            </tr>
          </thead>
          <tbody>
